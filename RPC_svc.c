...
rpc_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case findAverage:
		_xdr_argument = (xdrproc_t) xdr_intMatrix;
		_xdr_result = (xdrproc_t) xdr_float;
		local = (char *(*)(char *, struct svc_req *)) findaverage_1_svc;
		break;

	case findMinMax:
		_xdr_argument = (xdrproc_t) xdr_intMatrix;
		_xdr_result = (xdrproc_t) xdr_intMatrix;
		local = (char *(*)(char *, struct svc_req *)) findminmax_1_svc;
		break;

	case mulMatrixWithFloat:
		_xdr_argument = (xdrproc_t) xdr_mulFloat;
		_xdr_result = (xdrproc_t) xdr_floatMatrix;
		local = (char *(*)(char *, struct svc_req *)) mulmatrixwithfloat_1_svc;
		break;
